...
const EMPTY_DEFAULTS = (suggestedNumber: string): OrderInput => ({
  ...
  items: [{ product_id: '', quantity: 1, unit_price: 0, line_discount_percent: 0, line_discount_amount_input: 0, tax_rate: 10 }],
  order_discount_percent: 0,
  order_discount_amount_input: 0,
  shipping_cost: 0,
  status: 'confirmed',
...
export function OrderForm({
  ...
  const handleBulkPaste = () => {
    ...
    const matched: { product_id: string; quantity: number; unit_price: number; line_discount_percent: number; line_discount_amount_input: number; tax_rate: number }[] = [];
  ...
  const totals = calculateOrderTotals({
    ...
    order_discount_amount_input: Number(watch('order_discount_amount_input')) || 0,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4 md:grid-cols-3">
              ...
              <div className="col-span-2 space-y-1.5 md:col-span-1">
                ...
                <SearchSelect
                  ...
                  value={watch('delivery_province') ?? null}
                  onChange={(v) => setValue('delivery_province', v)}
          ...
          <div className="space-y-2 rounded-md border border-border p-3">
            <div className="grid grid-cols-12 gap-2 px-1 text-xs font-medium uppercase tracking-wide text-muted-foreground">
              ...
              <span className="col-span-1">İnd. %</span>
              <span className="col-span-2">İnd. ₺ (ops.)</span>
            ...
            {fields.map((field, index) => {
              ...
              return (
                <div key={field.id} className="grid grid-cols-12 items-center gap-2">
                  ...
                  <div className="col-span-2">
                    <Input type="number" step="0.01" min={0} placeholder="0" {...register(`items.${index}.line_discount_amount_input`)} />
                  </div>
            ...
            <div className="flex gap-2">
              <Button
                ...
                onClick={() => append({ product_id: '', quantity: 1, unit_price: 0, line_discount_percent: 0, line_discount_amount_input: 0, tax_rate: 10 })}
              >
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="grid grid-cols-3 gap-4">
              <div className="space-y-1.5">
                <Label>Sipariş İnd. (%)</Label>
                <Input type="number" step="0.01" min={0} max={100} {...register('order_discount_percent')} />
              </div>
              <div className="space-y-1.5">
                <Label>Sipariş İnd. (₺)</Label>
                <Input type="number" step="0.01" min={0} placeholder="0" {...register('order_discount_amount_input')} />
              </div>
              <div className="space-y-1.5">
